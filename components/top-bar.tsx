...
import { CandleMascot } from "@/components/candle-mascot"
...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-6 shadow-sm">
      {/* Search */}
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-9 bg-muted/50 border-0 rounded-xl font-poppins"
            value={searchQuery}
